...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Link'
        db.create_table('tasks_link', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.Page'])),
            ('link', self.gf('django.db.models.fields.CharField')(default=u'', max_length=2048)),
            ('link_type', self.gf('django.db.models.fields.CharField')(default='web', max_length=8)),
            ('link_anchor', self.gf('django.db.models.fields.CharField')(default=u'', max_length=256)),
            ('remote_page_title', self.gf('django.db.models.fields.CharField')(default=u'', max_length=256)),
            ('img_size', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('tasks', ['Link'])
